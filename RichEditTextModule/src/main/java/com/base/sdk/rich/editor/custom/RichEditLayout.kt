package com.base.sdk.rich.editor.custom
...
import com.base.sdk.rich.editor.R
...
class RichEditLayout @JvmOverloads constructor(context: Context,attr: AttributeSet?=null,defaultAttr:Int = 0)
  ...
  init {
    ...
    mRichEditText.setEnableStyle(arrayListOf(TextBoldStyle(),TextSkewStyle(),TextUnderLineStyle(), TextSizeStyle(),TextColorStyle(),
